...
Mode: ${debug.flying ? `flying${debug.turbo ? " — TURBO" : ""} (double-tap Space: turbo · fly down to land)` : debug.swimming ? "swimming (Space/Shift to rise/dive)" : "walking (double-tap Space to fly)"}
