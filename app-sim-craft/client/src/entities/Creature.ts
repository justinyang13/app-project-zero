...
const SPECIES: Record<CreatureSpecies, SpeciesSpec> = {
  ...
  pig: {
    speed: 1.0,
    bodySize: [0.6, 0.6, 0.9],
    bodyColor: 0xf2e3dd,
    headSize: [0.35, 0.3, 0.3],
    headColor: 0xe8d7c3,
    headForwardOffset: 0.45,
    legHeight: 0.3,
    legColor: 0x1c1c1c,
  ...
  chicken: {
    ...
    bodyColor: 0xe8e0d0,
    headSize: [0.15, 0.1, 0.15],
    headColor: 0x7f4a29,
    headForwardOffset: 0.25,
    legHeight: 0.15,
    legColor: 0xb83d00,
    hasTail: true,
  },
  horse: {
    speed: 2.2,
    bodySize: [1.2, 1.0, 1.8],
    bodyColor: 0x9e8760,
    headSize: [0.45, 0.35, 0.45],
    headColor: 0x8d6e3f,
    headForwardOffset: 0.65,
    legHeight: 0.5,
    legColor: 0x7c5a3d,
    hasTail: true,
  },
  fox: {
    speed: 2.1,
    bodySize: [0.4, 0.3, 0.7],
    bodyColor: 0xa64b21,
    headSize: [0.25, 0.2, 0.25],
    headColor: 0x923d14,
  ...
  wolf: {
    speed: 2.3,
    bodySize: [0.7, 0.6, 1.1],
    bodyColor: 0x524a44,
    headSize: [0.4, 0.35, 0.4],
    headColor: 0x3d342f,
    headForwardOffset: 0.45,
    legHeight: 0.4,
    legColor: 0x1c1c1a,
  ...
  deer: {
    speed: 2.0,
    bodySize: [0.6, 0.7, 0.9],
    bodyColor: 0xc3a87e,
    headSize: [0.3, 0.25, 0.3],
    headColor: 0x9c8155,
    headForwardOffset: 0.45,
    legHeight: 0.45,
    legColor: 0x7d6842,
  ...
  rabbit: {
    speed: 2.7,
    bodySize: [0.3, 0.3, 0.4],
    bodyColor: 0xd1c6b7,
    headSize: [0.18, 0.15, 0.18],
    headColor: 0xb7ac9a,
    headForwardOffset: 0.25,
    legHeight: 0.15,
    legColor: 0x847661,
  ...
  duck: {
    speed: 2.2,
    bodySize: [0.3, 0.25, 0.6],
    bodyColor: 0x3a8e9d,
    headSize: [0.17, 0.13, 0.17],
    headColor: 0x3a8e9d,
    headForwardOffset: 0.25,
    legHeight: 0.1,
    legColor: 0xe8d7c3,
  ...
  unicorn: {
    speed: 2.6,
    bodySize: [0.7, 0.8, 1.3],
    bodyColor: 0xf0f0f0,
    headSize: [0.35, 0.4, 0.35],
    headColor: 0xf5f5f5,
    headForwardOffset: 0.6,
    legHeight: 0.5,
    legColor: 0xe8e8e8,
    hasTail: true,
  },
